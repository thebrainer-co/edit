...
(function () {
  ...
  var C = ds.color || '#004F46', C2 = ds.paper || '#F7F2E7', INK = '#1C1B16', ACC = '#D9930D';
...
#hv-pan{position:fixed;right:16px;bottom:74px;z-index:2147483000;width:440px;max-width:calc(100vw - 32px);max-height:min(88vh,800px);background:' + C2 + ';color:' + INK + ';border-radius:14px;box-shadow:0 14px 44px rgba(0,0,0,.3);display:none;flex-direction:column;overflow:hidden;font:15px/1.45 system-ui,-apple-system,sans-serif}\
...
.hv-m{padding:9px 12px;border-radius:10px;max-width:92%;white-space:pre-wrap}.hv-m.a{max-width:100%;width:100%;box-sizing:border-box;background:#fff;align-self:flex-start;border:1px solid rgba(0,0,0,.12)}.hv-m.u{background:' + C + ';color:' + C2 + ';align-self:flex-end}\
.hv-chips{display:flex;flex-wrap:wrap;gap:6px;padding:10px 0 2px;margin-top:8px;border-top:1px dashed rgba(0,0,0,.15)}.hv-chips button{border:1px solid ' + C + ';background:#fff;color:' + C + ';border-radius:999px;padding:7px 12px;font:600 13px system-ui,sans-serif;cursor:pointer}.hv-chips button.pri{background:' + C + ';color:' + C2 + '}.hv-chips button.warn{border-color:#B3402A;color:#B3402A}\
#hv-pan,#hv-pan *{font-family:system-ui,-apple-system,sans-serif !important;box-sizing:border-box}#hv-form{padding:10px 12px 12px;border-top:1px solid rgba(0,0,0,.12)}.hv-box{background:#fff;border:1.5px solid rgba(0,0,0,.18);border-radius:14px;padding:10px 10px 6px 12px}.hv-box:focus-within{border-color:' + C + '}.hv-box textarea{display:block;width:100%;border:0;outline:0;resize:none;background:transparent;font:16px/1.4 system-ui,sans-serif;color:' + INK + ';min-height:44px;max-height:140px;padding:2px 0}\
.hv-tools{display:flex;justify-content:space-between;align-items:center;gap:6px;margin-top:4px}.hv-tools .hv-r{display:flex;gap:6px;margin-left:auto}.hv-tools button{border:0;background:transparent;color:#4E4A3F;width:36px;height:36px;border-radius:50%;cursor:pointer;display:inline-flex;align-items:center;justify-content:center}.hv-tools #hv-mic.on{color:#fff;background:#B3402A}.hv-tools #hv-send{background:' + C + ';color:' + C2 + '}.hv-tools #hv-send:disabled{opacity:.35}.hv-tools [hidden]{display:none}\
@media(max-width:699px){#hv-pan{right:0;left:0;bottom:0;width:auto;max-width:none;border-radius:14px 14px 0 0;max-height:92vh;height:92vh}#hv-pan header small{display:none}#hv-pan header button{font-size:14px;font-weight:600;border:1px solid rgba(255,255,255,.6);border-radius:6px;padding:6px 10px}.hv-chips{flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none}.hv-chips::-webkit-scrollbar{display:none}.hv-chips button{flex:0 0 auto}}\
...
#hv-addimg{position:absolute;z-index:2147482000;padding:10px 16px;border:0;border-radius:8px;background:' + ACC + ';color:' + INK + ';font:700 14px system-ui;cursor:pointer;box-shadow:0 4px 14px rgba(0,0,0,.3)}';
